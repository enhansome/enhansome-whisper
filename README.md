...
* [Source code](https://github.com/openai/whisper) ⭐ 108,700 | 🐛 146 | 🌐 Python | 📅 2026-08-31
* [White paper](https://cdn.openai.com/papers/whisper.pdf)

## Model variants

* [Whisper.cpp](https://github.com/ggerganov/whisper.cpp) ⭐ 53,503 | 🐛 442 | 🌐 C++ | 📅 2026-09-04 - Port of Whisper in C++.
  * [Bindings for many languages](https://github.com/ggerganov/whisper.cpp#bindings) ⭐ 53,503 | 🐛 442 | 🌐 C++ | 📅 2026-09-04
* [faster-whisper](https://github.com/guillaumekln/faster-whisper) ⭐ 25,275 | 🐛 320 | 🌐 Python | 📅 2025-11-19 - Faster reimplementation of Whisper using CTranslate2.
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 23,924 | 🐛 218 | 🌐 Python | 📅 2026-08-30 - Adds fast automatic speaker recognition with word-level timestamps and speaker diarization.
* [Whisper JAX](https://github.com/sanchit-gandhi/whisper-jax) ⭐ 4,681 | 🐛 138 | 🌐 Jupyter Notebook | 📅 2024-04-03 - JAX implementation of Whisper for up to 70x speed-up on TPU.
* [whisper-timestamped](https://github.com/linto-ai/whisper-timestamped) ⭐ 2,843 | 🐛 49 | 🌐 Python | 📅 2026-08-17 - Adds word-level timestamps and confidence scores.
* [Whisper-AT](https://github.com/YuanGongND/whisper-at) ⭐ 425 | 🐛 29 | 🌐 Python | 📅 2024-02-21 - Whisper that can recognize non-speech audio events in addition to speech.
* [whisper-openvino](https://github.com/zhuzilin/whisper-openvino) ⭐ 185 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2023-11-06 - Whisper running on OpenVINO.
...
* [Buzz](https://github.com/chidiwilliams/Buzz) ⭐ 21,370 | 🐛 20 | 🌐 Python | 📅 2026-09-06 - Audio transcription and translation macOS app.
* [VoiceInk](https://github.com/Beingpax/VoiceInk) ⭐ 6,345 | 🐛 127 | 🌐 Swift | 📅 2026-09-06 - Dictation and transcription macOS app. (FOSS)
* [OpenSuperWhisper](https://github.com/Starmel/OpenSuperWhisper) ⭐ 2,827 | 🐛 87 | 🌐 Swift | 📅 2026-09-07 - Dictation app for macOS. (FOSS)
* [TypeWhisper](https://github.com/TypeWhisper/typewhisper-mac) ⭐ 1,776 | 🐛 90 | 🌐 Swift | 📅 2026-09-07 - Local speech-to-text transcription for macOS and Windows with system-wide dictation.
* [Speech Note](https://github.com/mkiol/dsnote) ⭐ 1,630 | 🐛 145 | 🌐 C++ | 📅 2026-09-07 - Audio transcription Linux app.
* [Whisper](https://github.com/woheller69/whisperIME) ⭐ 632 | 🐛 21 | 🌐 Java | 📅 2026-08-30 - Android app for transcription and translation. (FOSS)
...
* [Subs AI](https://github.com/abdeladim-s/subsai) ⭐ 1,681 | 🐛 77 | 🌐 Python | 📅 2026-04-20 - Subtitle generation.
* [writeout.ai](https://github.com/beyondcode/writeout.ai) ⭐ 1,525 | 🐛 8 | 🌐 PHP | 📅 2026-06-30 - Laravel app to transcribe and translate audio files.
...
* [whisper-diarization](https://github.com/MahmoudAshraf97/whisper-diarization) ⭐ 5,643 | 🐛 42 | 🌐 Jupyter Notebook | 📅 2026-08-15 - Automatic speech recognition with speaker diarization.
* [whisper-standalone-win](https://github.com/Purfview/whisper-standalone-win) ⭐ 3,175 | 🐛 10 | 📅 2025-11-07 - Standalone Windows executable for Whisper and Faster Whisper.
* [yt-whisper](https://github.com/m1guelpf/yt-whisper) ⭐ 1,444 | 🐛 24 | 🌐 Python | 📅 2024-01-16 - YouTube subtitle generation.
* [whisper-ctranslate2](https://github.com/Softcatala/whisper-ctranslate2) ⭐ 1,347 | 🐛 13 | 🌐 Python | 📅 2026-02-14 - Whisper command-line tool based on CTranslate2, compatible with the original.
* [insanely-fast-whisper-cli](https://github.com/ochen1/insanely-fast-whisper-cli) ⭐ 409 | 🐛 6 | 🌐 Python | 📅 2024-06-08 - Achieve transcription speeds near 30x real-time with several optimizations.
* [hns](https://github.com/primaprashant/hns) ⭐ 116 | 🐛 4 | 🌐 Python | 📅 2026-09-06 - On-device speech-to-text CLI using faster-whisper with automatic clipboard copy.
* [phonix](https://github.com/platisd/phonix) ⭐ 48 | 🐛 1 | 🌐 Python | 📅 2025-03-28 - Generate captions for videos.

## Playgrounds

* [Monster API](https://whisperui.monsterapi.ai) - Whisper demo running on Monster API. ([Source](https://github.com/saharmor/whisper-playground) ⭐ 835 | 🐛 16 | 🌐 Python | 📅 2025-09-12)
* [YouTube Video Transcription](https://github.com/ArthurFDLR/whisper-youtube) ⭐ 419 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2024-04-23 - Running on Colab.
...
* [Discussions](https://github.com/openai/whisper/discussions) ⭐ 108,700 | 🐛 146 | 🌐 Python | 📅 2026-08-31
...
* [awesome-chatgpt](https://github.com/sindresorhus/awesome-chatgpt) ⭐ 6,399 | 🐛 6 | 📅 2026-02-15 - ChatGPT resources.
