...
* [Source code](https://github.com/openai/whisper) ⭐ 109,215 | 🐛 149 | 🌐 Python | 📅 2026-08-31
* [White paper](https://cdn.openai.com/papers/whisper.pdf)

## Model variants

* [Whisper.cpp](https://github.com/ggerganov/whisper.cpp) ⭐ 53,706 | 🐛 350 | 🌐 C++ | 📅 2026-09-15 - Port of Whisper in C++.
  * [Bindings for many languages](https://github.com/ggerganov/whisper.cpp#bindings) ⭐ 53,706 | 🐛 350 | 🌐 C++ | 📅 2026-09-15
* [faster-whisper](https://github.com/guillaumekln/faster-whisper) ⭐ 25,427 | 🐛 323 | 🌐 Python | 📅 2025-11-19 - Faster reimplementation of Whisper using CTranslate2.
* [WhisperX](https://github.com/m-bain/whisperX) ⭐ 24,068 | 🐛 223 | 🌐 Python | 📅 2026-08-30 - Adds fast automatic speaker recognition with word-level timestamps and speaker diarization.
...
* [Buzz](https://github.com/chidiwilliams/Buzz) ⭐ 21,527 | 🐛 20 | 🌐 Python | 📅 2026-09-12 - Audio transcription and translation macOS app.
* [VoiceInk](https://github.com/Beingpax/VoiceInk) ⭐ 6,433 | 🐛 133 | 🌐 Swift | 📅 2026-09-16 - Dictation and transcription macOS app. (FOSS)
* [OpenSuperWhisper](https://github.com/Starmel/OpenSuperWhisper) ⭐ 2,892 | 🐛 89 | 🌐 Swift | 📅 2026-09-15 - Dictation app for macOS. (FOSS)
* [TypeWhisper](https://github.com/TypeWhisper/typewhisper-mac) ⭐ 1,792 | 🐛 85 | 🌐 Swift | 📅 2026-09-16 - Local speech-to-text transcription for macOS and Windows with system-wide dictation.
* [Speech Note](https://github.com/mkiol/dsnote) ⭐ 1,651 | 🐛 146 | 🌐 C++ | 📅 2026-09-16 - Audio transcription Linux app.
* [Whisper](https://github.com/woheller69/whisperIME) ⭐ 640 | 🐛 21 | 🌐 Java | 📅 2026-08-30 - Android app for transcription and translation. (FOSS)
...
* [whisper-diarization](https://github.com/MahmoudAshraf97/whisper-diarization) ⭐ 5,649 | 🐛 41 | 🌐 Jupyter Notebook | 📅 2026-08-15 - Automatic speech recognition with speaker diarization.
* [whisper-standalone-win](https://github.com/Purfview/whisper-standalone-win) ⭐ 3,185 | 🐛 10 | 📅 2025-11-07 - Standalone Windows executable for Whisper and Faster Whisper.
...
* [Discussions](https://github.com/openai/whisper/discussions) ⭐ 109,215 | 🐛 149 | 🌐 Python | 📅 2026-08-31
...
* [awesome-chatgpt](https://github.com/sindresorhus/awesome-chatgpt) ⭐ 6,408 | 🐛 6 | 📅 2026-02-15 - ChatGPT resources.
